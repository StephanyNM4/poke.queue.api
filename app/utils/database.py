...
import pyodbc ## conecta y ejecuta consultas en bases de datos compatibles con ODBC (como SQL Server).
import logging ## gestiona logs de información o errores.
import json ##convierte los resultados a JSON.
